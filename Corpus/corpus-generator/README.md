...
```bash
mvn -q -DskipTests package   # from ~/Desktop/DiscoveryHub
java -jar corpus-generator/target/corpus-generator.jar --help
```
...
See <a href="../../message-schema.md">message-schema.md</a> for the wire format.
